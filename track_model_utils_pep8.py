...
def save_model(
    ...
    def unique_id():
        ...
        return (
            ...
            f"{dt.minute:02d}" + f"{dt.second:02d}"
        )
    ...
    df_feats = pd.DataFrame(train.columns, columns=[
                            user_name + "-" + model_id]).T
    ...
    if save:
        ...
        Pkl_Filename = f"{dir_models}/model_" + \
            user_name + "-" + model_id + ".pkl"
        ...
        for t in tipo_file:
            if dir_results_files.startswith("s3"):
                ...
                if len(results_files) == 0:
                    ...
                    results_files = [[n for n in fls]
                                     for _, _, fls in os_walk][0]
